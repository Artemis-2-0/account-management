...
@Configuration
@Profile({"local", "clean"})
public class AccountManagementOpenApiConfig {

    @Bean
    public OpenAPI customOpenAPI(@Value("${artemis-am.api.version}") String apiVersion){
        ...
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("Artemis Account Managment API")
                        .version(apiVersion)
                        .contact(new Contact()
